...
public class Mediator {
    ...
    void mediatorDemo(){
        ...
        actor1.sendMessage("topic2", "topic2 icin message");
        actor1.sendMessage("topic3", "topic3 icin message");
        actor1.sendMessage("topic4", "topic4 icin message");

        actor2.sendMessage("topic1", "topic1 icin message");
